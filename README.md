<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&pause=1000&color=38BC71&center=true&vCenter=true&width=435&lines=Hi+there%2C+I'm+Vikrant+Kumar;Full-Stack+Developer;Cybersecurity+Enthusiast;Open+Source+Contributor" alt="Typing SVG" />
</div>

<!-- Profile Views Counter -->
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=vikrantwiz02&label=Profile%20views&color=38BC71&style=for-the-badge" alt="Profile Views" />
</p>

<!-- Social Badges -->
<p align="center">
  <a href="https://github.com/vikrantwiz02?tab=followers">
    <img src="https://img.shields.io/github/followers/vikrantwiz02?label=Followers&logo=github&style=for-the-badge&logoColor=white&color=38BC71" alt="GitHub followers" />
  </a>
  <a href="https://github.com/vikrantwiz02?tab=stars">
    <img src="https://img.shields.io/github/stars/vikrantwiz02?style=for-the-badge&logo=github&logoColor=white&color=38BC71" alt="GitHub stars" />
  </a>
</p>

<!-- ASCII Art Name -->
<div align="center">
<pre style="color: #38BC71; background-color: transparent; font-family: 'Courier New', monospace; font-weight: bold;">
  ██╗   ██╗██╗██╗  ██╗██████╗  █████╗ ███╗   ██╗████████╗
  ██║   ██║██║██║ ██╔╝██╔══██╗██╔══██╗████╗  ██║╚══██╔══╝
  ██║   ██║██║█████╔╝ ██████╔╝███████║██╔██╗ ██║   ██║   
  ╚██╗ ██╔╝██║██╔═██╗ ██╔══██╗██╔══██║██║╚██╗██║   ██║   
...
<div align="center">
  ...
  <div align="left" style="display: inline-block; text-align: left; margin-right: 20px; max-width: 500px; background-color: #0d1117; padding: 20px; border-radius: 10px; border: 1px solid #30363d;">
    <p style="font-family: 'Courier New', monospace; color: #38BC71;">
      <span style="color: #38BC71;">vikrant@dev</span>:<span style="color: #3b8eea;">~</span>$ ./about_me.sh
    </p>
    
    <p style="font-family: 'Courier New', monospace; color: #e6edf3;">
      <span style="color: #38BC71;">▶</span> Location: IIITDM Jabalpur, India
      <br>
      <span style="color: #38BC71;">▶</span> Mission: Building tech that saves lives
      <br>
      <span style="color: #38BC71;">▶</span> Specialization: HealthTech, GovTech, Emergency Systems
      <br>
    ...
    <p style="font-family: 'Courier New', monospace; color: #e6edf3;">
      I'm the developer who stays up late fixing security vulnerabilities 
      others don't see. My code doesn't just run—it protects.
      
      When disaster strikes, my applications respond. When systems fail, 
      my backup protocols activate. I build digital safety nets for the 
      real world.
      
      By day: Student and developer.
    ...
    <p style="font-family: 'Courier New', monospace; color: #e6edf3;">
      <span style="color: #ffff00;">⚡</span> I can solve a Rubik's cube in under 2 minutes and apply the same 
      algorithmic thinking to crack complex coding problems!
      
      <span style="color: #ffff00;">⚡</span> Once built an emergency alert system that helped evacuate 
      200+ people during a flash flood simulation.
    </p>
...
<div align="center">
  <!-- Skill Bars - SVG Based -->
  <div style="background-color: #0d1117; padding: 20px; border-radius: 10px; max-width: 700px; margin: 0 auto;">
    <!-- React.js -->
    <div style="margin-bottom: 15px;">
      <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
        <div style="display: flex; align-items: center;">
          ...
          <span style="font-weight: 600; color: #e6edf3;">React.js</span>
        </div>
        <span style="color: #38BC71; font-weight: 600;">85%</span>
      </div>
      <div style="height: 8px; background-color: #21262d; border-radius: 4px; overflow: hidden;">
        <div style="height: 100%; width: 85%; background-color: #38BC71; border-radius: 4px;"></div>
      </div>
    </div>
    ...
    <div style="margin-bottom: 15px;">
      <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
        <div style="display: flex; align-items: center;">
          ...
          <span style="font-weight: 600; color: #e6edf3;">Node.js</span>
        </div>
        <span style="color: #38BC71; font-weight: 600;">75%</span>
      </div>
      <div style="height: 8px; background-color: #21262d; border-radius: 4px; overflow: hidden;">
        <div style="height: 100%; width: 75%; background-color: #38BC71; border-radius: 4px;"></div>
      </div>
    </div>
    ...
    <div style="margin-bottom: 15px;">
      <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
        <div style="display: flex; align-items: center;">
          ...
          <span style="font-weight: 600; color: #e6edf3;">Python</span>
        </div>
        <span style="color: #38BC71; font-weight: 600;">90%</span>
      </div>
      <div style="height: 8px; background-color: #21262d; border-radius: 4px; overflow: hidden;">
        <div style="height: 100%; width: 90%; background-color: #38BC71; border-radius: 4px;"></div>
      </div>
    </div>
    ...
    <div style="margin-bottom: 15px;">
      <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
        <div style="display: flex; align-items: center;">
          <svg viewBox="0 0 24 24" width="18" height="18" style="margin-right: 8px;">
            <path fill="#FFD700" d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z"/>
          </svg>
          <span style="font-weight: 600; color: #e6edf3;">Cybersecurity</span>
        </div>
        <span style="color: #38BC71; font-weight: 600;">80%</span>
      </div>
      <div style="height: 8px; background-color: #21262d; border-radius: 4px; overflow: hidden;">
        <div style="height: 100%; width: 80%; background-color: #38BC71; border-radius: 4px;"></div>
      </div>
    </div>
    ...
    <div style="margin-bottom: 15px;">
      <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
        <div style="display: flex; align-items: center;">
          ...
          <span style="font-weight: 600; color: #e6edf3;">Tailwind CSS</span>
        </div>
        <span style="color: #38BC71; font-weight: 600;">80%</span>
      </div>
      <div style="height: 8px; background-color: #21262d; border-radius: 4px; overflow: hidden;">
    ...
    <div style="margin-bottom: 15px;">
      <div style="display: flex; justify-content: space-between; margin-bottom: 5px;">
        <div style="display: flex; align-items: center;">
          ...
          <span style="font-weight: 600; color: #e6edf3;">Blockchain Dev</span>
        </div>
        <span style="color: #38BC71; font-weight: 600;">50%</span>
      </div>
      <div style="height: 8px; background-color: #21262d; border-radius: 4px; overflow: hidden;">
        <div style="height: 100%; width: 50%; background-color: #38BC71; border-radius: 4px;"></div>
      </div>
    </div>
  </div>
  
  <!-- Skill Categories -->
  <div style="display: flex; flex-wrap: wrap; justify-content: center; margin-top: 30px; gap: 15px;">
    <div style="background-color: #0d1117; padding: 15px; border-radius: 10px; width: 200px; text-align: center; border: 1px solid #30363d;">
      <div style="font-size: 24px; margin-bottom: 10px;">🔒</div>
      <div style="font-weight: bold; margin-bottom: 5px; color: #e6edf3;">Security Focus</div>
      <div style="font-size: 14px; color: #8b949e;">Penetration Testing, Vulnerability Assessment, Secure Coding</div>
    </div>
    
    <div style="background-color: #0d1117; padding: 15px; border-radius: 10px; width: 200px; text-align: center; border: 1px solid #30363d;">
      <div style="font-size: 24px; margin-bottom: 10px;">🚀</div>
      <div style="font-weight: bold; margin-bottom: 5px; color: #e6edf3;">Performance</div>
      <div style="font-size: 14px; color: #8b949e;">Code Optimization, Load Testing, Scalable Architecture</div>
    </div>
    
    <div style="background-color: #0d1117; padding: 15px; border-radius: 10px; width: 200px; text-align: center; border: 1px solid #30363d;">
      <div style="font-size: 24px; margin-bottom: 10px;">🔄</div>
      <div style="font-weight: bold; margin-bottom: 5px; color: #e6edf3;">DevOps</div>
      <div style="font-size: 14px; color: #8b949e;">CI/CD, Docker, AWS, Automated Testing</div>
    </div>
    
    <div style="background-color: #0d1117; padding: 15px; border-radius: 10px; width: 200px; text-align: center; border: 1px solid #30363d;">
      <div style="font-size: 24px; margin-bottom: 10px;">📱</div>
      <div style="font-weight: bold; margin-bottom: 5px; color: #e6edf3;">Mobile Dev</div>
      <div style="font-size: 14px; color: #8b949e;">React Native, Android Security, Cross-platform</div>
    </div>
  </div>
</div>
...
<div align="center">
      ...
      <tr>
        <td width="50%">
          ...
          <div align="center">
            ...
            <p><strong>React Native, Firebase</strong> - A technology-driven solution designed to save lives during natural disasters with real-time alerts, navigation assistance, and resource tracking.</p>
          </div>
        </td>
        <td width="50%">
          ...
          <div align="center">
            ...
            <p><strong>React, Node, MongoDB</strong> - A fully responsive, full-stack project providing key insights into academics, campus life, and events for students and aspirants.</p>
          </div>
        </td>
      </tr>
      <tr>
        <td width="50%">
          <h3 align="center">Electron & Chromium Release Tracker</h3>
          <div align="center">
            <a href="#" target="_blank"><img src="https://dummyimage.com/600x300/38BC71/ffffff&text=Release+Tracker" width="400" alt="Release Tracker"/></a>
            <p>
            ...
            <p><strong>JavaScript, React</strong> - A streamlined tool that helps developers monitor version updates in real time with a clean, calendar-style dashboard.</p>
          </div>
        </td>
        <td width="50%">
          <h3 align="center">Mongo-PHP Generator</h3>
          <div align="center">
            <a href="#" target="_blank"><img src="https://dummyimage.com/600x300/38BC71/ffffff&text=Mongo-PHP+Generator" width="400" alt="Mongo-PHP Generator"/></a>
            <p>
              <a href="#" target="_blank">
                <img src="https://img.shields.io/badge/Code-View%20Code-informational?style=for-the-badge&logo=github&logoColor=white&color=38BC71" alt="View Code" />
              </a>
            ...
            <p><strong>PHP, MongoDB</strong> - A dynamic tool designed to streamline the creation of PHP-based forms that insert data directly into MongoDB collections.</p>
          </div>
        </td>
      </tr>
    </table>
  ...
  <details>
    ...
    <table>
      <tr>
        <td width="50%">
          <h3 align="center">Cardiovascular Biomaterial CFD Simulator</h3>
          <div align="center">
            <a href="#" target="_blank"><img src="https://dummyimage.com/600x300/38BC71/ffffff&text=Cardio+CFD" width="400" alt="Cardio CFD"/></a>
            <p>
              <a href="#" target="_blank">
                <img src="https://img.shields.io/badge/Code-View%20Code-informational?style=for-the-badge&logo=github&logoColor=white&color=38BC71" alt="View Code" />
              </a>
            </p>
            <p><strong>Python, OpenFOAM</strong> - A desktop tool that enables simulation of blood flow around devices like stents, heart valves, and grafts to optimize device design and reduce complications.</p>
          </div>
        </td>
        <td width="50%">
...
<div align="center">
  <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px;">
    ...
    <img src="https://img.shields.io/badge/EC--Council-Android%20Security%20%26%20Bug%20Bounty-38BC71?style=for-the-badge&logo=android&logoColor=white" alt="EC-Council Android Security"/>
    <img src="https://img.shields.io/badge/Google-IT%20Support%20Professional-38BC71?style=for-the-badge&logo=google&logoColor=white" alt="Google IT Support Professional"/>
    <img src="https://img.shields.io/badge/AWS-Cloud%20Practitioner%20Essentials-38BC71?style=for-the-badge&logo=amazon-aws&logoColor=white" alt="AWS Cloud Practitioner"/>
    <img src="https://img.shields.io/badge/Accenture-Technology%20Job%20Simulation-38BC71?style=for-the-badge&logo=accenture&logoColor=white" alt="Accenture Technology Job Simulation"/>
...
<div align="center">
  ...
  <a href="mailto:vikrantwiz02@gmail.com" target="_blank">
    <img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email" />
  </a>
  <a href="https://github.com/vikrantwiz02" target="_blank">
    <img src="https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white" alt="GitHub" />
  </a>
  <a href="https://vikrantwiz02.github.io" target="_blank">
...
<!-- Footer Wave -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=38BC71&height=120&section=footer"/>

<!-- Hidden Easter Egg -->
<!--
Fun fact: This README was crafted with ❤️ and a lot of ☕
-->
